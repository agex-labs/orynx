...
const (
	...
	// Version is a label for the Orynx version.
	Version = "version"
)
...
type Metrics interface {
	...
	// SetOrynxBuildInfo sets the build information for the Orynx binary.
	SetOrynxBuildInfo()
}
...
type OracleMetricsImpl struct {
	...
	orynxBuildInfo  *prometheus.GaugeVec
}
...
func NewMetrics() Metrics {
	m := &OracleMetricsImpl{
		...
		orynxBuildInfo: prometheus.NewGaugeVec(prometheus.GaugeOpts{
			Namespace: OracleSubsystem,
			Name:      "orynx_build_info",
			Help:      "Information about the orynx build",
		}, []string{Version}),
	}
	...
	prometheus.MustRegister(m.orynxBuildInfo)
...
// SetOrynxBuildInfo sets the build information for the Orynx binary.
func (m *noOpOracleMetrics) SetOrynxBuildInfo() {}
...
// SetOrynxBuildInfo sets the build information for the Orynx binary. The version exported
// is determined by the build time version in accordance with the build pkg.
func (m *OracleMetricsImpl) SetOrynxBuildInfo() {
	m.orynxBuildInfo.With(prometheus.Labels{
		Version: build.Build,
	}).Set(1)
}
