...
import (
	...
	metricmocks "github.com/agex-labs/orynx/oracle/metrics/mocks"
	"github.com/agex-labs/orynx/oracle/types"
	mathtestutils "github.com/agex-labs/orynx/pkg/math/testutils"
...
func (s *OracleTestSuite) TestMetrics() {
	...
	metrics.On("SetOrynxBuildInfo").Return()
