...
// source: orynx/service/v1/oracle.proto
...
import (
	...
	types "github.com/agex-labs/orynx/x/marketmap/types"
...
func init() {
	proto.RegisterType((*QueryPricesRequest)(nil), "orynx.service.v1.QueryPricesRequest")
	proto.RegisterType((*QueryPricesResponse)(nil), "orynx.service.v1.QueryPricesResponse")
	proto.RegisterMapType((map[string]string)(nil), "orynx.service.v1.QueryPricesResponse.PricesEntry")
	proto.RegisterType((*QueryMarketMapRequest)(nil), "orynx.service.v1.QueryMarketMapRequest")
	proto.RegisterType((*QueryMarketMapResponse)(nil), "orynx.service.v1.QueryMarketMapResponse")
	proto.RegisterType((*QueryVersionRequest)(nil), "orynx.service.v1.QueryVersionRequest")
	proto.RegisterType((*QueryVersionResponse)(nil), "orynx.service.v1.QueryVersionResponse")
}

func init() { proto.RegisterFile("orynx/service/v1/oracle.proto", fileDescriptor_e88883d464f0f25b) }
...
func (c *oracleClient) Prices(ctx context.Context, in *QueryPricesRequest, opts ...grpc.CallOption) (*QueryPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orynx.service.v1.Oracle/Prices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oracleClient) MarketMap(ctx context.Context, in *QueryMarketMapRequest, opts ...grpc.CallOption) (*QueryMarketMapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orynx.service.v1.Oracle/MarketMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oracleClient) Version(ctx context.Context, in *QueryVersionRequest, opts ...grpc.CallOption) (*QueryVersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orynx.service.v1.Oracle/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Oracle_Prices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orynx.service.v1.Oracle/Prices",
	}
...
func _Oracle_MarketMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orynx.service.v1.Oracle/MarketMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Oracle_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orynx.service.v1.Oracle/Version",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Oracle_serviceDesc = grpc.ServiceDesc{
	ServiceName: "orynx.service.v1.Oracle",
	...
	Metadata: "orynx/service/v1/oracle.proto",
}
