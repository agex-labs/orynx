...
type Metrics interface {
	...
	// ObserveMessageSize updates a histogram per orynx message type with the size of that message
	...
	ObservePriceForTicker(ticker orynxtypes.CurrencyPair, price float64)
	...
	AddValidatorPriceForTicker(validator string, ticker orynxtypes.CurrencyPair, price float64)
	...
	AddValidatorReportForTicker(validator string, ticker orynxtypes.CurrencyPair, status ReportStatus)
}
...
func (m *nopMetricsImpl) ObservePriceForTicker(_ orynxtypes.CurrencyPair, _ float64) {}
func (m *nopMetricsImpl) AddValidatorReportForTicker(_ string, _ orynxtypes.CurrencyPair, _ ReportStatus) {
}

func (m *nopMetricsImpl) AddValidatorPriceForTicker(_ string, _ orynxtypes.CurrencyPair, _ float64) {
}
...
func NewMetrics(chainID string) Metrics {
	m := &metricsImpl{
		...
		abciMethodLatency: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Help:      "The time it took for an ABCI method to execute orynx specific logic (in seconds)",
...
func (m *metricsImpl) ObservePriceForTicker(ticker orynxtypes.CurrencyPair, price float64) {
...
func (m *metricsImpl) AddValidatorPriceForTicker(validator string, ticker orynxtypes.CurrencyPair, price float64) {
...
func (m *metricsImpl) AddValidatorReportForTicker(validator string, ticker orynxtypes.CurrencyPair, rs ReportStatus) {
