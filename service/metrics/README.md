...
* **purpose**
    ...
    * The latency is measured over all orynx-specific code, and ignores any down-stream dependencies
* **labels**
...
* **purpose**
    * This prometheus histogram tracks the size of vote-extensions, and extended commits that orynx is transmitting 
* **labels**
    * `chain_id`: the chain-id of this oracle deployment
