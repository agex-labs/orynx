...
import (
	...
	"github.com/agex-labs/orynx/providers/base/api/errors"
	"github.com/agex-labs/orynx/providers/base/api/handlers"
	"github.com/agex-labs/orynx/providers/base/api/handlers/mocks"
	"github.com/agex-labs/orynx/providers/base/api/metrics"
	mockmetrics "github.com/agex-labs/orynx/providers/base/api/metrics/mocks"
...
var (
	...
	btcusd  = orynxtypes.NewCurrencyPair("BTC", "USD")
	ethusd  = orynxtypes.NewCurrencyPair("ETH", "USD")
	atomusd = orynxtypes.NewCurrencyPair("ATOM", "USD")
...
func TestAPIQueryHandler(t *testing.T) {
	testCases := []struct {
		...
		apiHandler     func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int]
		metrics        func() metrics.APIMetrics
		ids            []orynxtypes.CurrencyPair
		atomic         bool
	...
	}{
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				h := mocks.NewAPIDataHandler[orynxtypes.CurrencyPair, *big.Int](t)
				return h
			},
			metrics: func() metrics.APIMetrics {
		...
		},
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				expectedIDs := []orynxtypes.CurrencyPair{btcusd}
			...
			ids:    []orynxtypes.CurrencyPair{btcusd},
			atomic: true,
			responses: providertypes.GetResponse[orynxtypes.CurrencyPair, *big.Int]{
				Resolved: map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int]{
					btcusd: {
		...
		},
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				response := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](
					resolved,
					nil,
				)
		...
		},
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				h.On("CreateURL", []orynxtypes.CurrencyPair{btcusd}).Return(constantURL, nil).Maybe()
		...
		},
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				expectedIDs := []orynxtypes.CurrencyPair{btcusd, ethusd, atomusd}
			...
			ids:    []orynxtypes.CurrencyPair{btcusd, ethusd, atomusd},
			atomic: true,
			responses: providertypes.GetResponse[orynxtypes.CurrencyPair, *big.Int]{
				Resolved: map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int]{
					btcusd: {
		...
		},
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				h.On("CreateURL", []orynxtypes.CurrencyPair{btcusd}).Return(constantURL, nil).Maybe()
				h.On("CreateURL", []orynxtypes.CurrencyPair{ethusd}).Return(constantURL, nil).Maybe()
				h.On("CreateURL", []orynxtypes.CurrencyPair{atomusd}).Return(constantURL, nil).Maybe()

				btcResolved := map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int]{
					btcusd: {
						Value: big.NewInt(100),
					},
				}
				btcResponse := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](
					btcResolved,
					nil,
				)

				ethResolved := map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int]{
					ethusd: {
						Value: big.NewInt(200),
					},
				}
				ethResponse := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](
					ethResolved,
					nil,
				)

				atomResolved := map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int]{
					atomusd: {
						Value: big.NewInt(300),
					},
				}
				atomResponse := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](
					atomResolved,
					nil,
				)

				h.On("ParseResponse", []orynxtypes.CurrencyPair{btcusd}, newValidResponse()).Return(btcResponse).Maybe()
				h.On("ParseResponse", []orynxtypes.CurrencyPair{ethusd}, newValidResponse()).Return(ethResponse).Maybe()
				h.On("ParseResponse", []orynxtypes.CurrencyPair{atomusd}, newValidResponse()).Return(atomResponse).Maybe()
		...
		},
		{
			...
			apiHandler: func() handlers.APIDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				h.On("CreateURL", []orynxtypes.CurrencyPair{btcusd}).Return(constantURL, nil).Maybe()
				h.On("CreateURL", []orynxtypes.CurrencyPair{ethusd}).Return(constantURL+"eth", nil).Maybe()
				h.On("CreateURL", []orynxtypes.CurrencyPair{atomusd}).Return(constantURL, nil).Maybe()
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			handler, err := handlers.NewAPIQueryHandler[orynxtypes.CurrencyPair, *big.Int](
				logger,
				apiCfg,
				tc.requestHandler(),
				tc.apiHandler(),
			...
			responseCh := make(chan providertypes.GetResponse[orynxtypes.CurrencyPair, *big.Int], len(tc.ids))
			...
			resolved := make(map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int])
			unResolved := make(map[orynxtypes.CurrencyPair]providertypes.UnresolvedResult)
