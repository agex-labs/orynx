...
import (
	...
	"github.com/agex-labs/orynx/providers/base/websocket/handlers"
	handlermocks "github.com/agex-labs/orynx/providers/base/websocket/handlers/mocks"
	"github.com/agex-labs/orynx/providers/base/websocket/metrics"
	mockmetrics "github.com/agex-labs/orynx/providers/base/websocket/metrics/mocks"
...
func TestWebSocketQueryHandler(t *testing.T) {
	testCases := []struct {
		...
		dataHandler func() handlers.WebSocketDataHandler[orynxtypes.CurrencyPair, *big.Int]
	...
	}{
		{
			...
			dataHandler: func() handlers.WebSocketDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				dataHandler := handlermocks.NewWebSocketDataHandler[orynxtypes.CurrencyPair, *big.Int](t)
				return dataHandler
			},
			metrics: func() metrics.WebSocketMetrics {
		...
		},
		{
			...
			dataHandler: func() handlers.WebSocketDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				dataHandler.On("HandleMessage", mock.Anything).Return(
					providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](nil, nil),
					nil,
		...
		},
		{
			...
			dataHandler: func() handlers.WebSocketDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				response := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](resolved, nil)
				dataHandler.On("HandleMessage", mock.Anything).Return(
					response,
					nil,
					nil,
		...
		},
		{
			...
			dataHandler: func() handlers.WebSocketDataHandler[orynxtypes.CurrencyPair, *big.Int] {
				...
				response1 := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](resolved, nil)
				dataHandler.On("HandleMessage", mock.Anything).Return(
					response1,
					nil,
					nil,
				...
				response2 := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](resolved2, nil)
				dataHandler.On("HandleMessage", mock.Anything).Return(
					response2,
					nil,
					nil,
				...
				response3 := providertypes.NewGetResponse[orynxtypes.CurrencyPair, *big.Int](nil, unresolved)
				dataHandler.On("HandleMessage", mock.Anything).Return(
					response3,
					nil,
					nil,
			...
			ids: []orynxtypes.CurrencyPair{btcusd, ethusd},
			responses: providertypes.GetResponse[orynxtypes.CurrencyPair, *big.Int]{
				Resolved: map[orynxtypes.CurrencyPair]providertypes.ResolvedResult[*big.Int]{
					btcusd: {
						Value: big.NewInt(100),
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			handler, err := handlers.NewWebSocketQueryHandler[orynxtypes.CurrencyPair, *big.Int](
				logger,
				tc.cfg,
				tc.dataHandler(),
				tc.connHandler(),
			...
			responseCh := make(chan providertypes.GetResponse[orynxtypes.CurrencyPair, *big.Int], 20)
			...
			seenResponses := make(map[orynxtypes.CurrencyPair]bool)
