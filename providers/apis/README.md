...
* [Coinbase](./coinbase/README.md) - Coinbase is a cryptocurrency exchange that provides a free API for fetching cryptocurrency data. Coinbase is a **primary data source** for the oracle.
    ...
    * Check if a given market is supported: 
        * `curl https://api.coinbase.com/v2/prices/{AGEX-USDC}/spot | jq`
...
* [aGeX](./agex/README.md) - aGeX is a decentralized exchange built using the Cosmos SDK. aGeX is a market map provider - we use it to fetch the list of markets the side-car should fetch prices for.
