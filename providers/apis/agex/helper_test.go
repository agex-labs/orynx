...
var usdtusd = orynxtypes.NewCurrencyPair("USDT", "USD")
			...
			"USDT/USD": {
				...
				ProviderConfigs: []mmtypes.ProviderConfig{
					...
					},
					{
						Name:            huobi.Name,
						OffChainTicker:  "ethusdt",
						NormalizeByPair: &orynxtypes.CurrencyPair{Base: "ETH", Quote: "USD"},
						Invert:          true,
					},
					{
						Name:           kraken.Name,
					...
					},
					{
						Name:            kucoin.Name,
						OffChainTicker:  "BTC-USDT",
						NormalizeByPair: &orynxtypes.CurrencyPair{Base: "BTC", Quote: "USD"},
						Invert:          true,
					},
					{
						Name:           okx.Name,
