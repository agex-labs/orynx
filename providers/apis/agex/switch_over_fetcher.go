...
import (
	...
	orynxgrpc "github.com/agex-labs/orynx/pkg/grpc"
...
// agex x/prices market map fetcher and a x/marketmap fetcher. The fetcher
...
type SwitchOverFetcher struct {
	...
	// agexPricesFetcher is the fetcher for the agex x/prices market map.
...
// aGeX x/prices and x/marketmap fetchers.
func NewDefaultSwitchOverMarketMapFetcher(
	...
	// Construct the aGeX x/prices API handler.
	...
	// Construct the aGeX x/marketmap API handler.
	conn, err := orynxgrpc.NewClient(
		api.Endpoints[1].URL,
