...
// ResearchJSON is the go-struct that encompasses the agex research json, as hosted
// on [github](https://raw.githubusercontent.com/agex-labs/agex-web/main/public/configs/otherMarketData.json)
