...
func init() {
	proto.RegisterType((*OracleVoteExtension)(nil), "orynx.abci.v1.OracleVoteExtension")
	proto.RegisterMapType((map[uint64][]byte)(nil), "orynx.abci.v1.OracleVoteExtension.PricesEntry")
}

func init() {
	proto.RegisterFile("orynx/abci/v1/vote_extensions.proto", fileDescriptor_cca9d70763a0957a)
}
