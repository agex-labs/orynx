...
import (
	...
	servertypes "github.com/agex-labs/orynx/service/servers/oracle/types"
...
type OracleKeeper interface { //golint:ignore
	...
	SetPriceForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair, qp oracletypes.QuotePrice) error
}

// OracleClient defines the interface that must be fulfilled by the orynx client.
