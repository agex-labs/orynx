...
import (
	...
	abciaggregator "github.com/agex-labs/orynx/abci/strategies/aggregator"
	"github.com/agex-labs/orynx/abci/strategies/codec"
	"github.com/agex-labs/orynx/abci/strategies/currencypair"
	orynxabcitypes "github.com/agex-labs/orynx/abci/types"
...
type PreBlockHandler struct { //golint:ignore
	...
	keeper orynxabcitypes.OracleKeeper
...
func NewOraclePreBlockHandler(
	...
	oracleKeeper orynxabcitypes.OracleKeeper,
	metrics servicemetrics.Metrics,
...
func (h *PreBlockHandler) WrappedPreBlocker(mm *module.Manager) sdk.PreBlocker {
	return func(ctx sdk.Context, req *cometabci.RequestFinalizeBlock) (response *sdk.ResponsePreBlock, err error) {
		...
		start := time.Now()
		var prices map[orynxtypes.CurrencyPair]*big.Int
		defer func() {
			...
			if ctx.ExecMode() == sdk.ExecModeFinalize {
				...
				orynxabcitypes.RecordLatencyAndStatus(h.metrics, latency, err, servicemetrics.PreBlock)
