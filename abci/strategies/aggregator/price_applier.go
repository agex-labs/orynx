...
type PriceApplier interface {
	...
	ApplyPricesFromVoteExtensions(ctx sdk.Context, req *cometabci.RequestFinalizeBlock) (map[orynxtypes.CurrencyPair]*big.Int, error)
	...
	GetPricesForValidator(validator sdk.ConsAddress) map[orynxtypes.CurrencyPair]*big.Int
}
...
type oraclePriceApplier struct {
	...
	ok orynxabcitypes.OracleKeeper
...
func (opa *oraclePriceApplier) ApplyPricesFromVoteExtensions(ctx sdk.Context, req *cometabci.RequestFinalizeBlock) (map[orynxtypes.CurrencyPair]*big.Int, error) {
...
func (opa *oraclePriceApplier) GetPricesForValidator(validator sdk.ConsAddress) map[orynxtypes.CurrencyPair]*big.Int {
