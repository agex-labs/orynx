...
func NewCurrencyPairNotExistError(cp orynxtypes.CurrencyPair) CurrencyPairNotExistError {
...
func NewQuotePriceNotExistError(cp orynxtypes.CurrencyPair) QuotePriceNotExistError {
...
func NewCurrencyPairAlreadyExistsError(cp orynxtypes.CurrencyPair) CurrencyPairAlreadyExistsError {
