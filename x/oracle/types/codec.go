...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	legacy.RegisterAminoMsg(cdc, &MsgAddCurrencyPairs{}, "orynx/x/oracle/MsgAddCurrencyPairs")

	// register the MsgRemoveCurrencyPairs for amino serialization
	legacy.RegisterAminoMsg(cdc, &MsgRemoveCurrencyPairs{}, "orynx/x/oracle/MsgRemoveCurrencyPairs")
}
