...
func init() {
	proto.RegisterType((*MsgAddCurrencyPairs)(nil), "orynx.oracle.v1.MsgAddCurrencyPairs")
	proto.RegisterType((*MsgAddCurrencyPairsResponse)(nil), "orynx.oracle.v1.MsgAddCurrencyPairsResponse")
	proto.RegisterType((*MsgRemoveCurrencyPairs)(nil), "orynx.oracle.v1.MsgRemoveCurrencyPairs")
	proto.RegisterType((*MsgRemoveCurrencyPairsResponse)(nil), "orynx.oracle.v1.MsgRemoveCurrencyPairsResponse")
}

func init() { proto.RegisterFile("orynx/oracle/v1/tx.proto", fileDescriptor_1cd987ee4c7d5236) }
...
func (c *msgClient) AddCurrencyPairs(ctx context.Context, in *MsgAddCurrencyPairs, opts ...grpc.CallOption) (*MsgAddCurrencyPairsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orynx.oracle.v1.Msg/AddCurrencyPairs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveCurrencyPairs(ctx context.Context, in *MsgRemoveCurrencyPairs, opts ...grpc.CallOption) (*MsgRemoveCurrencyPairsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orynx.oracle.v1.Msg/RemoveCurrencyPairs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddCurrencyPairs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orynx.oracle.v1.Msg/AddCurrencyPairs",
	}
...
func _Msg_RemoveCurrencyPairs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orynx.oracle.v1.Msg/RemoveCurrencyPairs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "orynx.oracle.v1.Msg",
	...
	Metadata: "orynx/oracle/v1/tx.proto",
}
