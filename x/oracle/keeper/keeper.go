...
func (k *Keeper) RemoveCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) error {
...
func (k *Keeper) HasCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) bool {
...
func (k *Keeper) GetPriceWithNonceForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) (types.QuotePriceWithNonce, error) {
...
func (k *Keeper) GetNonceForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) (uint64, error) {
...
func (k *Keeper) GetPriceForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) (types.QuotePrice, error) {
	cps, err := k.currencyPairs.Get(ctx, cp.String())
	if err != nil {
...
func (k *Keeper) SetPriceForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair, qp types.QuotePrice) error {
...
func (k *Keeper) CreateCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) error {
...
func (k *Keeper) GetIDForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) (uint64, bool) {
	cps, err := k.currencyPairs.Get(ctx, cp.String())
	if err != nil {
		return 0, false
	}
...
func (k *Keeper) GetCurrencyPairFromID(ctx sdk.Context, id uint64) (orynxtypes.CurrencyPair, bool) {
	// use the ID index to match the given ID
	ids, err := k.idIndex.MatchExact(ctx, id)
	if err != nil {
		return orynxtypes.CurrencyPair{}, false
	}
	// close the iterator
	defer ids.Close()
	if !ids.Valid() {
	...
	cp, err := orynxtypes.CurrencyPairFromString(cps)
	if err != nil {
		return orynxtypes.CurrencyPair{}, false
	}
...
func (k *Keeper) GetAllCurrencyPairs(ctx sdk.Context) []orynxtypes.CurrencyPair {
	cps := make([]orynxtypes.CurrencyPair, 0)

	// aggregate CurrencyPairs stored under KeyPrefixNonce
	k.IterateCurrencyPairs(ctx, func(cp orynxtypes.CurrencyPair, _ types.CurrencyPairState) {
		cps = append(cps, cp)
	})
...
func (k *Keeper) GetCurrencyPairMapping(ctx sdk.Context) (map[uint64]orynxtypes.CurrencyPair, error) {
	numPairs, err := k.numCPs.Get(ctx)
	if err != nil {
		return nil, err
	}
	pairs := make(map[uint64]orynxtypes.CurrencyPair, numPairs)
	// aggregate CurrencyPairs stored under KeyPrefixNonce
	k.IterateCurrencyPairs(ctx, func(cp orynxtypes.CurrencyPair, cps types.CurrencyPairState) {
		pairs[cps.GetId()] = cp
	})
...
func (k *Keeper) GetCurrencyPairMappingList(ctx sdk.Context) ([]types.CurrencyPairMapping, error) {
	...
	// aggregate CurrencyPairs stored under KeyPrefixNonce
	err := k.IterateCurrencyPairs(ctx, func(cp orynxtypes.CurrencyPair, cps types.CurrencyPairState) {
...
func (k *Keeper) IterateCurrencyPairs(ctx sdk.Context, cb func(cp orynxtypes.CurrencyPair, cps types.CurrencyPairState)) error {
	...
	for ; it.Valid(); it.Next() {
		...
		cp, err := orynxtypes.CurrencyPairFromString(primaryKey)
		if err != nil {
			return err
		}
...
func (k *Keeper) GetDecimalsForCurrencyPair(ctx sdk.Context, cp orynxtypes.CurrencyPair) (decimals uint64, err error) {
	if k.mmKeeper == nil {
