...
func init() {
	proto.RegisterType((*GenesisState)(nil), "orynx.marketmap.v1.GenesisState")
}

func init() { proto.RegisterFile("orynx/marketmap/v1/genesis.proto", fileDescriptor_a621f29fb8bf99f4) }
