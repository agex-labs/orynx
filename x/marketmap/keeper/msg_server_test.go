...
import (
	...
	"github.com/agex-labs/orynx/x/marketmap/keeper"
	"github.com/agex-labs/orynx/x/marketmap/types"
	mmmocks "github.com/agex-labs/orynx/x/marketmap/types/mocks"
)
...
func (s *KeeperTestSuite) TestMsgServerCreateMarkets() {
	...
	s.Require().Equal([]orynxtypes.CurrencyPair{btcusdt.Ticker.CurrencyPair, usdtusd.Ticker.CurrencyPair}, cps)
