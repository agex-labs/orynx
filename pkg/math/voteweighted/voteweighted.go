...
) aggregator.AggregateFnFromContext[string, map[orynxtypes.CurrencyPair]*big.Int] {
	return func(ctx sdk.Context) aggregator.AggregateFn[string, map[orynxtypes.CurrencyPair]*big.Int] {
...
func Median(
	...
	validatorStore ValidatorStore,
	threshold math.LegacyDec,
) aggregator.AggregateFn[string, map[orynxtypes.CurrencyPair]*big.Int] {
	return func(providers aggregator.AggregatedProviderData[string, map[orynxtypes.CurrencyPair]*big.Int]) map[orynxtypes.CurrencyPair]*big.Int {
		priceInfo := make(map[orynxtypes.CurrencyPair]PriceInfo)
		...
		prices := make(map[orynxtypes.CurrencyPair]*big.Int)
