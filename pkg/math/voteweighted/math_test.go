...
import (
	...
	"github.com/agex-labs/orynx/pkg/math/voteweighted/mocks"
...
func (s *MathTestSuite) TestMedian() {
	cases := []struct {
		name              string
		providerPrices    aggregator.AggregatedProviderData[string, map[orynxtypes.CurrencyPair]*big.Int]
		...
		},
		{
			...
			providerPrices: aggregator.AggregatedProviderData[string, map[orynxtypes.CurrencyPair]*big.Int]{
				validator1.String(): map[orynxtypes.CurrencyPair]*big.Int{
					{
						Base:  "BTC",
						Quote: "USD",
					}: big.NewInt(100),
		...
		},
		{
			...
			providerPrices: aggregator.AggregatedProviderData[string, map[orynxtypes.CurrencyPair]*big.Int]{
				...
				validator2.String(): map[orynxtypes.CurrencyPair]*big.Int{
					{
						Base:  "BTC",
						Quote: "USD",
					}: big.NewInt(200),
		...
		},
		{
			...
			providerPrices: aggregator.AggregatedProviderData[string, map[orynxtypes.CurrencyPair]*big.Int]{
				...
				validator3.String(): map[orynxtypes.CurrencyPair]*big.Int{
					{
						Base:  "BTC",
						Quote: "USD",
					}: big.NewInt(300),
		...
		},
		{
			...
			totalBondedTokens: sdkmath.NewInt(99),
			expectedPrices: map[orynxtypes.CurrencyPair]*big.Int{ // only btc/usd should be included
				{
					Base:  "BTC",
					Quote: "USD",
				}: big.NewInt(300),
