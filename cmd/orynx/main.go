...
import (
	...
	"github.com/agex-labs/orynx/cmd/build"
	cmdconfig "github.com/agex-labs/orynx/cmd/orynx/config"
	"github.com/agex-labs/orynx/oracle"
	"github.com/agex-labs/orynx/oracle/config"
	oraclemetrics "github.com/agex-labs/orynx/oracle/metrics"
	"github.com/agex-labs/orynx/pkg/log"
	oraclemath "github.com/agex-labs/orynx/pkg/math/oracle"
	"github.com/agex-labs/orynx/providers/apis/marketmap"
	oraclefactory "github.com/agex-labs/orynx/providers/factories/oracle"
	mmservicetypes "github.com/agex-labs/orynx/service/clients/marketmap/types"
	oracleserver "github.com/agex-labs/orynx/service/servers/oracle"
	promserver "github.com/agex-labs/orynx/service/servers/prometheus"
...
var (
	rootCmd = &cobra.Command{
		Use:   "oracle",
		Short: "Run the orynx oracle server.",
		Args:  cobra.NoArgs,
...
func init() {
	rootCmd.Flags().StringVarP(
		...
		"",
		marketmap.Name,
		"MarketMap provider to use (marketmap_api, agex_api, agex_migration_api).",
	)
	rootCmd.Flags().StringVarP(
		&oracleCfgPath,
		"oracle-config",
