...
[Sidecar Dashboard JSON file](https://github.com/agex-labs/orynx/blob/main/grafana/provisioning/dashboards/side-car-dashboard.json)

### Application

[Application Dashboard JSON file](https://github.com/agex-labs/orynx/blob/main/grafana/provisioning/dashboards/chain-dashboard.json)