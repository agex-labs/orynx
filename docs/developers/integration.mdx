...
First, add the [x/marketmap](https://github.com/agex-labs/orynx/blob/main/x/marketmap/README.md) and [x/oracle](https://github.com/agex-labs/orynx/tree/main/x/oracle) keepers to the application.
...
import (
	...
	marketmapkeeper "github.com/agex-labs/orynx/x/marketmap/keeper"
...
import (
    ...
    oracleclient "github.com/agex-labs/orynx/service/clients/oracle"
...
import (
    ...
    oraclepreblock "github.com/agex-labs/orynx/abci/preblock/oracle"
    compression "github.com/agex-labs/orynx/abci/strategies/codec"
    "github.com/agex-labs/orynx/abci/strategies/currencypair"
