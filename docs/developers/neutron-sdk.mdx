...
The snippets below are not a complete implementation. Please check out the complete smart contract [example](https://github.com/kubiklabs/neutron-dev-contracts/tree/orynx_contracts/contracts/neutron_orynx) for a complete implementation.
...
For a complete example see the [full example](https://github.com/kubiklabs/neutron-dev-contracts/blob/orynx_contracts/contracts/neutron_orynx/src/contract.rs#L140-L242).
