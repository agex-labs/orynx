...
func init() {
	file_orynx_abci_v1_vote_extensions_proto_init()
	md_OracleVoteExtension = File_orynx_abci_v1_vote_extensions_proto.Messages().ByName("OracleVoteExtension")
...
func (x *OracleVoteExtension) slowProtoReflect() protoreflect.Message {
	mi := &file_orynx_abci_v1_vote_extensions_proto_msgTypes[0]
...
func (x *fastReflection_OracleVoteExtension) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "orynx.abci.v1.OracleVoteExtension.prices":
		return len(x.Prices) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orynx.abci.v1.OracleVoteExtension"))
		}
		panic(fmt.Errorf("message orynx.abci.v1.OracleVoteExtension does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OracleVoteExtension) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message orynx.abci.v1.OracleVoteExtension does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OracleVoteExtension) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in orynx.abci.v1.OracleVoteExtension", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: orynx/abci/v1/vote_extensions.proto
...
func (*OracleVoteExtension) Descriptor() ([]byte, []int) {
	return file_orynx_abci_v1_vote_extensions_proto_rawDescGZIP(), []int{0}
}
...
var File_orynx_abci_v1_vote_extensions_proto protoreflect.FileDescriptor

var file_orynx_abci_v1_vote_extensions_proto_rawDesc = []byte{
	0x0a, 0x24, 0x73, 0x6c, 0x69, 0x6e, 0x6b, 0x79, 0x2f, 0x61, 0x62, 0x63, 0x69, 0x2f, 0x76, 0x31,
	0x2f, 0x76, 0x6f, 0x74, 0x65, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x73, 0x6c, 0x69, 0x6e, 0x6b, 0x79, 0x2e, 0x61,
	0x62, 0x63, 0x69, 0x2e, 0x76, 0x31, 0x22, 0x99, 0x01, 0x0a, 0x13, 0x4f, 0x72, 0x61, 0x63, 0x6c,
...
var (
	file_orynx_abci_v1_vote_extensions_proto_rawDescOnce sync.Once
	file_orynx_abci_v1_vote_extensions_proto_rawDescData = file_orynx_abci_v1_vote_extensions_proto_rawDesc
)

func file_orynx_abci_v1_vote_extensions_proto_rawDescGZIP() []byte {
	file_orynx_abci_v1_vote_extensions_proto_rawDescOnce.Do(func() {
		file_orynx_abci_v1_vote_extensions_proto_rawDescData = protoimpl.X.CompressGZIP(file_orynx_abci_v1_vote_extensions_proto_rawDescData)
	})
	return file_orynx_abci_v1_vote_extensions_proto_rawDescData
}

var file_orynx_abci_v1_vote_extensions_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_orynx_abci_v1_vote_extensions_proto_goTypes = []interface{}{
	(*OracleVoteExtension)(nil), // 0: orynx.abci.v1.OracleVoteExtension
	nil,                         // 1: orynx.abci.v1.OracleVoteExtension.PricesEntry
}
var file_orynx_abci_v1_vote_extensions_proto_depIdxs = []int32{
	1, // 0: orynx.abci.v1.OracleVoteExtension.prices:type_name -> orynx.abci.v1.OracleVoteExtension.PricesEntry
...
func init() { file_orynx_abci_v1_vote_extensions_proto_init() }
func file_orynx_abci_v1_vote_extensions_proto_init() {
	if File_orynx_abci_v1_vote_extensions_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_orynx_abci_v1_vote_extensions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_orynx_abci_v1_vote_extensions_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_orynx_abci_v1_vote_extensions_proto_goTypes,
		DependencyIndexes: file_orynx_abci_v1_vote_extensions_proto_depIdxs,
		MessageInfos:      file_orynx_abci_v1_vote_extensions_proto_msgTypes,
	}.Build()
	File_orynx_abci_v1_vote_extensions_proto = out.File
	file_orynx_abci_v1_vote_extensions_proto_rawDesc = nil
	file_orynx_abci_v1_vote_extensions_proto_goTypes = nil
	file_orynx_abci_v1_vote_extensions_proto_depIdxs = nil
}
